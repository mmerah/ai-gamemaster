    ...
    <div v-if="contentType === 'equipment'" class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
          <select
            v-model="equipment.equipment_category"
            required
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
          >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <div class="flex gap-2">
            ...
            />
            <select
              v-model="equipment.cost_unit"
              required
              class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
            >
      ...
      <div v-if="equipment.equipment_category === 'Weapon'" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            >
            <select
              v-model="equipment.weapon_category"
              required
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
            >
          ...
          <div>
            ...
            >
            <select
              v-model="equipment.weapon_range"
              required
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
            >
    ...
    <div v-if="contentType === 'classes'" class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
          <select
            v-model.number="charClass.hit_die"
            required
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
          >
      ...
      >
        <div>
          ...
          >
          <select
            v-model="charClass.spellcasting_ability"
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold"
          >
...
const isValid = computed(() => {
  if (props.contentType === 'spells') {
    return (
      spell.value.name &&
      spell.value.school &&
      spell.value.casting_time &&
      spell.value.duration &&
      spell.value.range &&
      spell.value.desc &&
    ...
    return (
      ...
      monster.value.hit_dice &&
      monster.value.speed
    )
  } else if (props.contentType === 'equipment') {
    return (
      equipment.value.name &&
      equipment.value.equipment_category &&
    ...
    return (
      race.value.name &&
      race.value.age &&
      race.value.size_description &&
      race.value.languages &&
      race.value.alignment
    )
  } else if (props.contentType === 'backgrounds') {
    return (
      background.value.name &&
      background.value.feature_name &&
    ...
    return (
      ...
      alignment.value.abbreviation &&
      alignment.value.desc
    )
    ...
    return (
      abilityScore.value.name &&
      abilityScore.value.full_name &&
      abilityScore.value.desc
    )
    ...
    return (
      magicItem.value.name && magicItem.value.rarity && magicItem.value.desc
    )
  } else if (props.contentType === 'subclasses') {
    return (
      subclass.value.name && subclass.value.class_ref && subclass.value.desc
    )
    ...
    return (
      charClass.value.name &&
      charClass.value.hit_die &&
      charClass.value.proficiencies &&
      charClass.value.saving_throws
    )
  }
  return false
})
  ...
  if (props.contentType === 'spells') {
    ...
    data = {
      ...
      school: {
        ...
        name:
          spell.value.school.charAt(0).toUpperCase() +
          spell.value.school.slice(1),
    ...
    const proficiencyBonus =
      Math.floor((monster.value.challenge_rating - 1) / 4) + 2
    ...
    data = {
      ...
      equipment_category: {
        index: equipment.value.equipment_category
          .toLowerCase()
          .replace(/\s+/g, '-'),
    ...
    if (equipment.value.equipment_category === 'Weapon') {
      ...
      data.range =
        equipment.value.weapon_range === 'Melee'
          ? { normal: 5 }
          : { normal: 80, long: 320 }
    }
  } else if (props.contentType === 'races') {
    ...
    data = {
      ...
      ability_bonuses: abilityBonuses as AbilityBonus[],
    ...
    data = {
      ...
      language_options:
        background.value.language_choices > 0
          ? {
    ...
    data = {
      ...
      skills: abilityScore.value.skills
        ? abilityScore.value.skills.split(',').map(s => ({
    ...
    data = {
      ...
      classes: proficiency.value.classes
        ? proficiency.value.classes.split(',').map(c => ({
            index: c.trim().toLowerCase(),
            name: c.trim(),
            url: `/api/classes/${c.trim().toLowerCase()}`,
          }))
        : [],
      races: proficiency.value.races
        ? proficiency.value.races.split(',').map(r => ({
    ...
    data = {
      ...
      subsections: rule.value.subsections
        ? rule.value.subsections.split(',').map(s => ({
            index: s.trim().toLowerCase().replace(/\s+/g, '-'),
            name: s.trim(),
    ...
    const index = equipmentCategory.value.name
      .toLowerCase()
      .replace(/\s+/g, '-')
    ...
    data = {
      ...
      equipment: equipmentCategory.value.equipment
        ? equipmentCategory.value.equipment
            .split('\n')
            .filter(line => line.trim())
            .map(item => ({
    ...
    data = {
      ...
      features: level.value.features
        ? level.value.features
            .split('\n')
            .filter(line => line.trim())
            .map(feat => ({
    ...
    data = {
      ...
      starting_equipment: charClass.value.starting_equipment
        ? charClass.value.starting_equipment
            .split('\n')
            .filter(line => line.trim())
            .map(equip => ({
              equipment: {
    ...
    if (
      charClass.value.is_spellcaster &&
      charClass.value.spellcasting_ability
    ) {
      data.spellcasting = {
        ...
        info: [
          {
            name: 'Spells Known',
            desc: [
              'You know a number of spells based on your level in this class.',
            ],
          },
        ],
      }
