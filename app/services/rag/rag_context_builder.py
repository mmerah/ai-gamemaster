...
class RAGContextBuilder:
    ...
    def extract_npcs_from_messages(self, messages: List[Dict]) -> List[str]:
    ...
    def build_rag_context_data_for_query(self, query: str, game_state: Any, messages: List[Dict]) -> Dict[str, Any]:
    ...
    def extract_rag_query(self, player_action_input: Optional[str], messages: List[Dict]) -> str:
        ...
        if player_action_input:
            ...
            if user_messages:
                ...
                logger.debug(f"Using extracted content from last user message as RAG query: {query[:50]}...")
    ...
    def _extract_raw_content_from_formatted_message(self, formatted_message: str) -> str:
