...
class TestOpenAIService:
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_strict_mode_success(self, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_strict_mode_fallback_to_flexible(self, mock_chat_openai):
        ...
        mock_structured_llm.invoke.return_value = {
            "parsed": None,
            "raw": AIMessage(content='{"narrative": "Fallback response", "dice_requests": []}')
        }
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_flexible_mode_success(self, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_flexible_mode_with_trailing_commas(self, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_empty_content(self, mock_chat_openai):
    ...
    def test_rate_limit_detection_and_retry(self, mock_sleep, mock_chat_openai):
        ...
        def side_effect(messages):
            ...
            if call_count == 1:
                ...
                return AIMessage(content='{"narrative": "Success after retry", "dice_requests": []}')
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    @patch('time.sleep')
    def test_max_retries_exhausted(self, mock_sleep, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_get_response_with_exception(self, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_structured_output_not_implemented(self, mock_chat_openai):
    ...
    @patch('app.ai_services.openai_service.ChatOpenAI')
    def test_parse_flexible_validation_error(self, mock_chat_openai):
