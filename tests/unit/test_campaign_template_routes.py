...
class TestCampaignTemplateRoutes:
    ...
    def test_get_all_templates(self, client, mock_template_repo, sample_template):
        """Test getting all campaign templates."""
        mock_template_repo.get_all_templates.return_value = [sample_template]
        
        with patch('app.routes.campaign_template_routes.get_container') as mock_get_container:
            mock_container = Mock()
            mock_container.get_campaign_template_repository.return_value = mock_template_repo
    ...
    def test_get_template_by_id(self, client, mock_template_repo, sample_template):
    ...
    def test_get_template_not_found(self, client, mock_template_repo):
    ...
    def test_create_template(self, client, mock_template_repo):
    ...
    def test_create_template_no_data(self, client):
    ...
    def test_create_template_invalid_data(self, client):
        ...
        with patch('app.routes.campaign_template_routes.get_container') as mock_get_container:
            ...
            data = json.loads(response.data)
            assert 'error' in data
            assert 'Invalid template data' in data['error']
    
    def test_update_template(self, client, mock_template_repo, sample_template):
        ...
        updated_template = CampaignTemplateModel(
            **{**sample_template.model_dump(), **update_data}
        )
    ...
    def test_update_template_not_found(self, client, mock_template_repo):
    ...
    def test_update_template_no_data(self, client, mock_template_repo, sample_template):
    ...
    def test_delete_template(self, client, mock_template_repo, sample_template):
    ...
    def test_delete_template_not_found(self, client, mock_template_repo):
    ...
    def test_create_campaign_from_template(self, client, mock_template_repo, sample_template):
        ...
        mock_campaign_service.create_campaign_instance.return_value = mock_campaign_instance
    ...
    def test_create_campaign_from_template_not_found(self, client, mock_template_repo):
