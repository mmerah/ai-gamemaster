...
class TestAbilityModifier:
    ...
    def test_edge_cases(self):
        ...
        assert get_ability_modifier("invalid") == 0
...
class TestDiceRolling:
    ...
    def test_roll_single_die(self, mock_randint):
...
class TestDiceFormula:
    ...
    @patch('app.game.calculators.dice_mechanics.random.randint')
    def test_simple_formula(self, mock_randint):
    ...
    @patch('app.game.calculators.dice_mechanics.random.randint')
    def test_formula_with_modifier(self, mock_randint):
    ...
    @patch('app.game.calculators.dice_mechanics.random.randint')
    def test_formula_with_negative_modifier(self, mock_randint):
    ...
    def test_non_string_formula(self):
        ...
        total, rolls, modifier, desc = roll_dice_formula(None)
        assert total == 0
        assert rolls == []
        assert modifier == 0
        assert "Invalid" in desc
