...
class TestCompletionTokenMonitor:
    ...
    def test_on_llm_end_with_token_usage(self) -> None:
    ...
    def test_on_llm_end_rate_limit_detection(self) -> None:
    ...
    def test_on_llm_end_no_rate_limit_with_zero_prompt(self) -> None:
    ...
    def test_on_llm_end_without_token_usage(self) -> None:
        ...
        response = LLMResult(generations=[[Generation(text="Test response")]])
    ...
    def test_on_llm_end_with_empty_token_usage(self) -> None:
    ...
    def test_multiple_calls_accumulation(self) -> None:
