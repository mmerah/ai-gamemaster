...
class TestCharacterTemplateValidation(unittest.TestCase):
    ...
    def get_minimal_valid_character(self) -> dict:
    ...
    def test_starting_gold_validation(self):
    ...
    def test_required_fields(self):
        ...
        required_fields = ["id", "name", "race", "char_class", "background", "alignment", "base_stats", "proficiencies"]
    ...
    def test_personality_traits_max_length(self):
    ...
    def test_class_feature_level_validation(self):
