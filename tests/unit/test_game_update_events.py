...
class TestBaseGameUpdateEvent:
    ...
    def test_base_event_has_required_fields(self):
        ...
        event = BaseGameUpdateEvent(event_type="test_event")
    ...
    def test_event_id_is_unique_uuid(self):
        ...
        event1 = BaseGameUpdateEvent(event_type="test")
        event2 = BaseGameUpdateEvent(event_type="test")
    ...
    def test_timestamp_auto_generated(self):
        ...
        event = BaseGameUpdateEvent(event_type="test")
    ...
    def test_sequence_number_increments(self):
        ...
        event1 = BaseGameUpdateEvent(event_type="test")
        event2 = BaseGameUpdateEvent(event_type="test")
        event3 = BaseGameUpdateEvent(event_type="test")
    ...
    def test_correlation_id_optional(self):
        ...
        # With correlation ID
        event2 = BaseGameUpdateEvent(event_type="test", correlation_id="combat_123")
...
class TestSpecificGameEvents:
    ...
    def test_narrative_added_event(self):
    ...
    def test_combatant_hp_changed_event(self):
        """Test HP change event structure."""
        from app.events.game_update_events import CombatantHpChangedEvent
    ...
    def test_dice_roll_events(self):
    ...
    def test_turn_advanced_event(self):
...
class TestEventInheritance:
    ...
    def test_all_events_inherit_base_fields(self):
        ...
        for event in events:
            ...
            assert isinstance(event, BaseGameUpdateEvent)
