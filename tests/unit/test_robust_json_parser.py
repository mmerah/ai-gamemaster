...
class SampleResponse(BaseModel):
    ...
    dice_requests: List[str] = Field(default_factory=list)
...
class TestRobustJsonOutputParser:
    ...
    def test_parse_multiline_json_with_commas(self) -> None:
    ...
    def test_parse_with_pydantic_validation(self) -> None:
    ...
    def test_parse_markdown_without_json_label(self) -> None:
    ...
    def test_parse_with_balanced_braces(self) -> None:
    ...
    def test_parse_failure_no_json(self) -> None:
    ...
    def test_parse_failure_invalid_json(self) -> None:
