...
class TestCampaignTemplateUnifiedCRUD(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {'CAMPAIGN_TEMPLATES_DIR': self.temp_dir}
        ...
        self.test_campaign = CampaignTemplateModel(
            ...
            allowed_races=["Human", "Elf", "Dwarf", "Halfling", "Dragonborn", "Tiefling"],
            allowed_classes=["Fighter", "Wizard", "Cleric", "Rogue", "Ranger", "Paladin"],
    ...
    def test_create_campaign_with_all_fields(self):
        ...
        self.assertEqual(saved_data["description"], "An epic campaign to save the realm from an ancient dragon's return")
        
        # Verify core campaign info
        self.assertEqual(saved_data["campaign_goal"], "Defeat the Shadow Dragon before it plunges the world into eternal darkness")
        ...
        self.assertEqual(saved_data["initial_npcs"]["king_aldric"]["name"], "King Aldric the Wise")
        self.assertEqual(saved_data["initial_npcs"]["king_aldric"]["last_location"], "Royal Palace")
        ...
        self.assertEqual(saved_data["initial_quests"]["gather_information"]["status"], "active")
    ...
    def test_read_campaign_preserves_all_fields(self):
        ...
        self.assertEqual(loaded_campaign.initial_npcs["king_aldric"].name, "King Aldric the Wise")
        
        # Check quests
        self.assertEqual(len(loaded_campaign.initial_quests), 3)
        self.assertIn("gather_information", loaded_campaign.initial_quests)
        self.assertEqual(loaded_campaign.initial_quests["gather_information"].status, "active")
    ...
    def test_update_campaign_all_fields(self):
        ...
        # Add new world lore
        campaign.world_lore.append("The Forge of Stars where the Dragonbane Sword was created still exists")
    ...
    def test_delete_campaign_with_all_fields(self):
    ...
    def test_campaign_without_optional_fields(self):
