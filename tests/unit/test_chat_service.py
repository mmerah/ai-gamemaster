...
class TestChatServiceEvents(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Inject the event queue
        self.chat_service.event_queue = self.mock_event_queue
    
    def test_chat_service_emits_narrative_event(self):
        """Test that add_message emits a NarrativeAddedEvent."""
        # Add a message
        content = "The goblin attacks!"
        self.chat_service.add_message("assistant", content, gm_thought="Rolling for attack")
    ...
    def test_user_message_emits_event(self):
    ...
    def test_system_message_emits_event(self):
    ...
    def test_invalid_role_does_not_emit_event(self):
    ...
    def test_event_includes_tts_audio_path(self):
        ...
        # Setup campaign service with narration enabled
        mock_container = MagicMock()
        mock_campaign_service = Mock()
        mock_campaign = Mock(narration_enabled=True)
    ...
    def test_event_includes_message_id(self):
    ...
    def test_event_preserves_kwargs(self):
