...
class TestCharacterAdventuresRoute:
    ...
    def test_get_character_adventures_success(self, client):
        ...
        instance2 = CampaignInstanceModel(
            ...
            character_ids=["char_template_2", "char_template_3"],  # Not including char_template_1
        ...
        mock_game_state.party = [mock_char_instance]
        ...
        with patch('app.routes.character_routes.get_container') as mock_get_container:
            ...
            mock_container.get_character_template_repository.return_value = mock_char_repo
            mock_container.get_campaign_instance_repository.return_value = mock_instance_repo
    ...
    def test_get_character_adventures_not_found(self, client):
    ...
    def test_get_character_adventures_no_campaigns(self, client):
        ...
        instance1 = CampaignInstanceModel(
            ...
            name="Some Adventure",
            template_id="campaign_1",
            character_ids=["other_char_1", "other_char_2"],  # Not including our character
    ...
    def test_get_character_adventures_with_no_game_state(self, client):
        ...
        with patch('app.routes.character_routes.get_container') as mock_get_container:
            ...
            # Fighter (d10 hit die), level 3, CON mod 0: 10 + (3-1) * 5.5 = 21
