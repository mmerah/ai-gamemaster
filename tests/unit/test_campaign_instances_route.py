...
class TestCampaignInstancesRoute:
    ...
    def test_get_campaign_instances_success(self, client, mock_instance_repo, sample_instances):
        ...
        with patch('app.routes.campaign_routes.get_container') as mock_get_container:
            ...
            assert first['created_at'] == '2025-05-23T17:02:00+00:00'  # Frontend compatibility
    ...
    def test_get_campaign_instances_empty(self, client, mock_instance_repo):
    ...
    def test_get_campaign_instances_error(self, client, mock_instance_repo):
    ...
    def test_get_campaign_instances_datetime_handling(self, client, mock_instance_repo):
