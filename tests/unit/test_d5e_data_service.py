...
class TestD5eDataService(unittest.TestCase):
    """Test the comprehensive D5e data service."""
...
class TestCharacterCreationHelpers(TestD5eDataService):
...
class TestSpellManagement(TestD5eDataService):
...
class TestCombatHelpers(TestD5eDataService):
...
class TestEquipmentHelpers(TestD5eDataService):
...
class TestRulesHelpers(TestD5eDataService):
...
class TestCharacterValidation(TestD5eDataService):
...
class TestUtilityMethods(TestD5eDataService):
