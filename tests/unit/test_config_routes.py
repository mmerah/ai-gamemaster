...
def test_get_configuration_with_env_vars(client):
    ...
    with patch('app.routes.config_routes.current_app') as mock_app, \
         patch('app.routes.config_routes.os.environ', mock_env):
        mock_app.config = mock_config
...
def test_get_configuration_handles_path_objects(client):
