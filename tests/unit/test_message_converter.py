...
class TestMessageConverter:
    ...
    def test_to_single_langchain_system_message(self) -> None:
    ...
    def test_to_single_langchain_human_message(self) -> None:
    ...
    def test_to_single_langchain_ai_message(self) -> None:
    ...
    def test_to_single_langchain_unknown_role(self) -> None:
    ...
    def test_to_single_langchain_empty_content(self) -> None:
    ...
    def test_from_single_langchain_system_message(self) -> None:
    ...
    def test_from_single_langchain_human_message(self) -> None:
    ...
    def test_from_single_langchain_ai_message(self) -> None:
