...
class TestEventRecorderCapabilities:
    ...
    def test_event_recorder_comprehensive_capabilities(self) -> None:
        ...
        from app.models.events import BackendProcessingEvent, CombatantHpChangedEvent
        ...
        assert (
            cast(NarrativeAddedEvent, narrative_events[0]).content == "Combat begins!"
        )
        ...
        assert cast(CombatantHpChangedEvent, hp_event).change_amount == -5
