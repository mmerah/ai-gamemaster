...
from app.database.models import Base, ContentPack
...
class D5eContentUpdater(D5eDataMigrator):
    ...
    def get_existing_indices(self, table_class: Type[Base]) -> Set[str]:
